...
export default function Home() {
  ...
  // Filter items in the inventory with quantity greater than 1
  ...
  return (
    <Box width="100vw" height="100vh" display="flex" justifyContent="center" flexDirection="column" alignItems="center" gap={2}>
      ...
      <Box border="1px solid #333">
        <Box width="800px" height="100px" bgcolor="skyblue" display="flex" alignItems="center" justifyContent="center">
